...
export const useThemeConfig = defineStore('themeConfig', {
	state: (): ThemeConfigState => ({
		themeConfig:{"isDrawer":false,"primary":"#1F5F4E","isIsDark":false,"topBar":"#ffffff","topBarColor":null,"isTopBarColorGradual":false,"menuBar":"#0F3B30","menuBarColor":"#EDEBE4","menuBarActiveColor":"rgba(255, 255, 255, 0.12)","isMenuBarColorGradual":false,"columnsMenuBar":"#545c64","columnsMenuBarColor":"#e6e6e6","isColumnsMenuBarColorGradual":false,"isColumnsMenuHoverPreload":false,"isCollapse":false,"isUniqueOpened":true,"isFixedHeader":false,"isFixedHeaderChange":false,"isClassicSplitMenu":false,"isLockScreen":false,"lockScreenTime":30,"isShowLogo":true,"isShowLogoChange":false,"isBreadcrumb":true,"isTagsview":true,"isBreadcrumbIcon":false,"isTagsviewIcon":false,"isCacheTagsView":true,"isSortableTagsView":true,"isShareTagsView":false,"isFooter":true,"isGrayscale":false,"isInvert":false,"isWartermark":false,"wartermarkText":"后台管理系统","tagsStyle":"tags-style-one","animation":"slide-right","columnsAsideStyle":"columns-round","columnsAsideLayout":"columns-vertical","layout":"defaults","isRequestRoutes":true,"globalTitle":"后台管理系统","globalViceTitle":"后台管理系统","globalViceTitleMsg":"专业、安全、高效、监管、服务","globalI18n":"zh-cn","globalComponentSize":"default","footerAuthor":"©2025 后台管理系统"} 
